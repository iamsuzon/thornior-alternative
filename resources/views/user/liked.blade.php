...
@section('content')
    <div class="row">
        @if(isset($posts) AND array_key_exists('liked_posts',$posts))
            @forelse($posts['liked_posts'] as $post)
                <div class="col-md-3 col-sm-3 col-12 mt-4 mr-sm-0">
                    <div class="blog-item">
                        ...
                        <div class="blog-more mt-2">
                            <span class="mr-2"><img src="{{asset('upload/blogger/avatar')}}/{{$post->blogger->image}}"
                                                    alt="" style="width: 25px;height: 25px;border-radius: 100%"></span>
