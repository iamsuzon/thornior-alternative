...
@section('content')
    ...
    <section class="bloger-iteml">
        <div class="section-wrapper">
            <div class="section-header">
                <h4 class="text-uppercase">Blogs</h4>
            </div>
            <ul class="blogerl-item">
                @if(isset($user_data['following_blogs']))
                    @forelse($user_data['following_blogs'] as $blog)
                        <li>
                            <a href="{{route('blog',$blog->blog->blog_slug)}}">
                                <div class="item-thumb">
                                    <img src="{{asset('upload/blogger/avatar')}}/{{$blog->blog->blogger->image}}"
                                         alt="">
                                </div>
    ...
    @if(isset($user_data['following_blogs']))
            ...
            <div class="section-wrapper overflow-hidden">
                ...
                <div class="latest-blog-slider">
                    <div class="swiper-wrapper">
                        @if(isset($user_data['latest_posts']))
                            @foreach($user_data['latest_posts'] as $post)
                                    ...
                                    <div class="blog-item style-one">
                                        ...
                                        <div class="blog-timeline">
                                            ...
                                            <span class="border-end pe-2"
                                                ...
                                                <span
                                                    style="font-size: 12px">{{$post->created_at->diffForHumans()}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="videos-blog pt-0 pb-5">
            <div class="section-wrapper overflow-hidden">
                <div class="section-header">
                    <h3 class="bg-transparent text-uppercase fs-5">Images <i
                            class="fa fa-angle-right"></i></h3>
                    <!-- slider arrow -->
                    <div class="slider-arrow">
    ...
    @else
        <h4 class="text-center pb-4">To See The Following Posts Please <a href="{{route('blogs')}}"
                                                                          style="color: #555555">Follow Bloggers >></a>
        </h4>
    @endif
@endsection
