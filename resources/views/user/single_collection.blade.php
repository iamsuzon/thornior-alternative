...
@section('content')
                ...
                <div class="modal-content">
                    ...
                    <form action="{{route('user.collection.update')}}" method="POST">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="{{route('user.collection.delete',$collection['single']->slug)}}"
                               class="btn btn-primary bg-danger text-white">Delete Collection
                            </a>
                        </div>
                    </form>
                </div>
    ...
    @if(isset($collection) AND array_key_exists('collection',$collection))
        @if($collection['collection'] != null)
            <div class="row">
            @foreach($collection['collection'] as $key => $post)
