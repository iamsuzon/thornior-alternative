    ...
    <div class="container">
        <div class="row gx-0">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                <div class="row">
                    @php
                        if(isset($post['post'])) $image = $post['post']->getMedia('video');
                        $i=1;
                    @endphp
                    <div class="col-lg-12 col-md-12 col-sm-12 col-inner-space">
                        <img class="rounded" src="@if(isset($image[$i]) AND $image[$i]->getCustomProperty('name') == 'image_1') {{$image[$i]->getUrl()}} @php $i++ @endphp @else {{asset('backend/assets/images/blog/placeholder.jpg')}} @endif" id="headline-one-image" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-5 col-md-5 offset-lg-2 offset-lg-2 col-sm-12 col-space">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-inner-space">
                        <img class="rounded" src="@if(isset($image[$i]) AND $image[$i]->getCustomProperty('name') == 'image_2') {{$image[$i]->getUrl()}} @php $i++ @endphp @else {{asset('backend/assets/images/blog/placeholder.jpg')}} @endif" id="headline-two-image" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row gx-0">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-inner-space">
                        <img class="rounded" src="@if(isset($image[$i]) AND $image[$i]->getCustomProperty('name') == 'image_3') {{$image[$i]->getUrl()}} @php $i++ @endphp @else {{asset('backend/assets/images/blog/placeholder.jpg')}} @endif" id="headline-three-image" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-5 col-md-5 offset-lg-2 offset-lg-2 col-sm-12 col-space">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-inner-space">
                        <img class="rounded" src="@if(isset($image[$i]) AND $image[$i]->getCustomProperty('name') == 'image_4') {{$image[$i]->getUrl()}} @php $i++ @endphp @else {{asset('backend/assets/images/blog/placeholder.jpg')}} @endif" id="headline-four-image" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row gx-0">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-inner-space">
                        <img class="rounded" src="@if(isset($image[$i]) AND $image[$i]->getCustomProperty('name') == 'image_5') {{$image[$i]->getUrl()}} @php $i++ @endphp @else {{asset('backend/assets/images/blog/placeholder.jpg')}} @endif" id="headline-five-image" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-5 col-md-5 offset-lg-2 offset-lg-2 col-sm-12 col-space">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-inner-space">
                        <img class="rounded" src="@if(isset($image[$i]) AND $image[$i]->getCustomProperty('name') == 'image_6') {{$image[$i]->getUrl()}} @php $i++ @endphp @else {{asset('backend/assets/images/blog/placeholder.jpg')}} @endif" id="headline-six-image" alt="">
                    </div>
                </div>
            </div>
        </div>
