        ...
        <div class="des-thumb">
            <div class="row">
                <div class="image-box col-lg-6 col-md-6 col-sm-6">
                    <img class="rounded" src="@if(isset($image[$i]) AND $image[$i]->getCustomProperty('name') == 'image_4') {{$image[$i]->getUrl()}} @php $i++ @endphp @else {{asset('backend/assets/images/blog/examp/01.jpg')}} @endif"
                         id="imageOutro1" alt="">
                </div>
                <div class="image-box col-lg-6 col-md-6 col-sm-6">
                    <img class="rounded" src="@if(isset($image[$i]) AND $image[$i]->getCustomProperty('name') == 'image_5') {{$image[$i]->getUrl()}} @php $i++ @endphp @else {{asset('backend/assets/images/blog/examp/01.jpg')}} @endif"
                         id="imageOutro2" alt="">
                </div>
            </div>
        </div>
