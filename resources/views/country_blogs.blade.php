...
<section class="latest-blog pt-0 mt-4">
    <div class="container">
                ...
                <div class="swiper-wrapper">
                    ...
                    @foreach($countries as $country)
                        <div class="swiper-slide">
                            <div class="blog-item style-one">
                                <div class="blog-text">
                                    <a href="{{route('blogs.country',$country->code)}}">
                                        <h5>{{$country->name}}</h5>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <a href="{{route('blog',$creator->blog->blog_slug)}}">
                                ...
                                <div class="card-text">
                                    ...
                                    <p>@if($creator->about==null) Have a tour from my amazing blog. Just click on my
