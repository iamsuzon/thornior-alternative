...
<div class="main-content">
    ...
    <!-- top navbar ends  -->
        ...
        <form action="{{route('blogger.blog.post.video.update.1',$post['post']->slug)}}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="post-left-nav-button d-inline-block float-start" style="margin-left: 20px">
                                <button type="submit" name="post_status" value="3" class="btn p-3"
                                        style="background-color: #fff">Save in Library
                                </button>
                            </div>
                            <div class="post-right-nav-button d-inline-block float-end" style="margin-right: 20px">
                                <button type="submit" name="post_status" value="0" class="btn p-3"
                                        style="background-color: #fff">Preview
                                </button>
                                <button type="submit" name="post_status" value="1" class="btn p-3"
                        ...
                        <div class="form-group" id="progressDiv" style="display: none">
                            ...
                            <p class="progress-text text-center"><strong>Don't reload or close this window while
                                    uploading</strong></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12">
                            ...
                            <div class="card mt-4">
                                ...
                                <div class="card-body">
                                    <div class="post-image">
                                        <p><input type="file" accept="image/*" name="thumbnail_image"
                                                  id="cover-image-input"
                                                  onchange="featuredImage(event)" style="display: none;"></p>
                                        <p id="image-label" class="text-center image-label"><label
                            ...
                            <div class="card mt-4">
                                ...
                                <div class="card-body">
                                    <div class="long-image">
                                        <div class="post-image">
                                            <p><input type="file" accept="image/*" name="image_1" id="filem"
                            ...
                            <div class="card mt-4">
                                <div class="card-body">
                                    <div class="post-image">
                                        <p><input type="file" accept="image/*" name="image_2" id="file1"
                                    ...
                                    <div class="post-image mt-5">
                                        <p><input type="file" accept="image/*" name="image_3" id="file2"
                                    ...
                                    <div class="post-image mt-5">
                                        <p><input type="file" accept="image/*" name="image_4" id="file3"
