...
<div class="main-content">
    ...
    <!-- top navbar ends  -->
        ...
        <form action="{{route('blogger.blog.post.video.update.2',$post['post']->slug)}}" method="POST"
                                    ...
                                    <div class="article-image mt-4">
                                        <div class="post-image">
                                            ...
                                            <p id="article_image_box_six" class="text-center"><img
                                                    src="@if(isset($post['post']->medias[$index]) AND $post['post']->medias[$index]->number == '6')
                                                    {{asset($post['post']->medias[$index]->address)}}
                                                    @php $index++ @endphp @else
                                                    {{asset('backend/assets/images/blog/placeholder.jpg')}}
                                                    @endif"
                                ...
                                <div class="card-body">
                                    <div class="post-image">
                                        ...
                                        <p class="text-center image-label" id="outro-image-label"><label for="outro-image-input"
                                                    ...
                                                    class="fas fa-camera"></i></label></p>
                                        <p id="image-box" class="text-center"><img
                                                src="@if(isset($post['post']->medias[$index]) AND $post['post']->medias[$index]->number == '7')
                                                {{asset($post['post']->medias[$index]->address)}}
                                                @php $index++ @endphp @else
                                                {{asset('backend/assets/images/blog/placeholder.jpg')}}
                                                @endif"
